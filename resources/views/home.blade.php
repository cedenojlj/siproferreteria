                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    @forelse ($kpis['topSellingProducts'] ?? [] as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <span class="badge {{ ($item->product->current_stock ?? 0) > ($item->product->min_stock ?? 10) ? 'bg-success' : 'bg-danger' }}">
                                                    {{ $item->product->current_stock ?? 'N/A' }}
                                                </span>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td colspan="3" class="text-center">No hay datos de ventas para mostrar.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
